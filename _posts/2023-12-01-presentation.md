...
<div class="message">
  ...
  <div style="display: flex; justify-content: center;">
    <div style="text-align: center; margin: 0 10px; flex: 1;">
      ...
      <p style="color: #c68d8e;">Data cleaning connoisseur</p>
      <p style="font-style: italic; color: #c68d8e;"> “Cleaning data is my cardio; watch me sweat those missing values away!” </p>
    </div>
    <div style="text-align: center; margin: 0 10px; flex: 1;">
      ...
      <p style="color: #c68d8e;">Visualization Virtuoso</p>
      <p style="font-style: italic;color: #c68d8e;">“I turn data into art; Picasso would've been jealous of my pie charts!”</p>
    </div>
    <div style="text-align: center; margin: 0 10px; flex: 1;">
      ...
      <p style="color: #c68d8e;">Litterature genius</p>
      <p style="font-style: italic;color: #c68d8e;">“?”</p>
    </div>
    <div style="text-align: center; margin: 0 10px; flex: 1;">
      ...
      <p style="color: #c68d8e;">Social expert</p>
      <p style="font-style: italic; color: #c68d8e;">“?”</p>
    </div>
    <div style="text-align: center; margin: 0 10px; flex: 1;">
      ...
      <p style="color: #c68d8e;">Predictive Modeling Prodigy</p>
      <p style="font-style: italic;color: #c68d8e;">“I'm not psychic, but my models are; they can predict your future better than a fortune cookie!”</p>
    </div>
  </div>
